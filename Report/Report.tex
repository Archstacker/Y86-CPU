...
\begin{figure}[htbp]
\centering
\includegraphics[width=5cm]{img/state.pdf}
\caption{Y86 基本变量}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/isa.pdf}
\caption{Y86指令集}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/icodes.pdf}
\caption{Y86指令集功能代码}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=8cm]{img/seq-fetch.pdf}
\caption{取指阶段}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=8cm]{img/seq-decode.pdf}
\caption{译码和回写阶段}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=8cm]{img/seq-execute.pdf}
\caption{执行阶段}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=8cm]{img/seq-memory.pdf}
\caption{访存阶段}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/pipe-full.pdf}
\caption{硬件结构}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/prog4-uncontrol.pdf}
\caption{“读后写”数据冒险}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/pipe-decode.pdf}
\caption{数据前推实现}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/eg-pipe-reg-full.pdf}
\caption{不同状态}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/prog7.pdf}
\caption{ret指令的实际处理情况}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/prog5-stall.pdf}
\caption{通过前推处理数据冒险}
\end{figure}
...
\section{CPU程序验证}\label{cpuux7a0bux5e8fux9a8cux8bc1}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim0.png}
\caption{sum程序运行结果}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim1.png}
\caption{eax第一次改变}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim2.png}
\caption{eax第二次改变}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim3.png}
\caption{eax第三次改变}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim4.png}
\caption{eax第四次改变}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{img/sim5.png}
\caption{eax第五次改变}
\end{figure}
...
本次实验中，我第一次尝试了使用git来管理代码，进行版本控制。本次实验持续时间长，代码前后改动非常大，使用git管理能让我很清楚的知道上次都修改了什么，错误都是在哪出的，我都做出来什么改进，同时，在这个过程中，我也根据实际情况尝试了很多git的功能。现在算起来，也有60多个commit了，有的修改较多，有的修改较少，现在看起来还是蛮有成就感的。
...
\subsection{下步期望}\label{ux4e0bux6b65ux671fux671b}
